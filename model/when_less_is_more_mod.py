...
# I need
# age	seniority 	segment		sex 	relationship income country of residence	activity 				regionNumber
# age 	antiguedad	segmento	sexo				 renta	pais_residencia			ind_actividad_cliente	cod_prov	
...
if __name__ == "__main__":
	...
	with open('cust_dict_save.pkl', 'rb') as f:
		...
		x_vars_list = processData(test_file, cust_dict)
		...
		out_df.to_csv('sub_xgb_new_mod.csv', index=False)
